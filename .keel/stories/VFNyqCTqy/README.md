...
- [ ] TurnEvent::GathererSearchProgress variant exists with phase, elapsed_seconds, and detail fields [SRS-03/AC-01] <!-- verify: manual, SRS-03:start:end -->
- [ ] Events emitted from gather_context as channel heartbeats arrive [SRS-03/AC-02] <!-- verify: manual, SRS-03:start:end -->
- [ ] event_type_key returns "gatherer_search_progress" [SRS-04/AC-03] <!-- verify: manual, SRS-04:start:end -->
- [ ] min_verbosity is 0 (always visible) [SRS-04/AC-04] <!-- verify: manual, SRS-04:start:end -->
