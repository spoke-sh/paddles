...
- [ ] InterpretationContext has a categories field with category, count, and sources per entry [SRS-01/AC-02] <!-- verify: manual, SRS-01:start:end -->
- [ ] build_interpretation_context_prompt instructs the model to return typed guidance categories [SRS-01/AC-03] <!-- verify: manual, SRS-01:start:end -->
