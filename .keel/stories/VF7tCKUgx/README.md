...
- [ ] The runtime exposes immediate local tools for search, file operations, shell commands, and edit/diff operations. [SRS-03/AC-01] <!-- verify: manual, SRS-03:start:end -->
- [ ] Tool results are recorded as searchable local context for later turns. [SRS-04/AC-01] <!-- verify: manual, SRS-04:start:end -->
