...
- [ ] Foundational and public docs explain deterministic resolution behavior, boundaries, and non-goals. [SRS-03/AC-01] <!-- verify: npm --workspace @paddles/docs run build, SRS-03:start:end -->
- [ ] Runtime or trace views expose resolver outcomes clearly enough to distinguish resolved, ambiguous, and missing targets during edit-oriented turns. [SRS-03/AC-02] <!-- verify: npm --workspace @paddles/web run test -- runtime-app.test.tsx, SRS-03:start:end -->
