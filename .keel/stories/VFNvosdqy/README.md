...
- [ ] After re-expansion, interpretation context is re-assembled from the expanded graph [SRS-01/AC-03] <!-- verify: manual, SRS-01:start:end -->
- [ ] Failure during re-expansion returns the original context unchanged [SRS-01/AC-04] <!-- verify: manual, SRS-01:start:end -->
