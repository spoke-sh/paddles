...
- [ ] Boundary checks detect infrastructure dependencies leaking into domain code. [SRS-03/AC-01] <!-- verify: cargo test architecture_boundary -- --nocapture, SRS-03:start:end -->
- [ ] Boundary check documentation explains the expected domain, application, and infrastructure dependency direction. [SRS-04/AC-01] <!-- verify: manual, SRS-04:start:end -->
