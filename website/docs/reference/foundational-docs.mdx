...
3. **ARCHITECTURE.md** for the detailed runtime taxonomy and influence snapshots
4. [Steering Signals](../concepts/context-pressure.mdx) for the public-facing explanation
