...
3. [Context Tiers](./concepts/context-tiers.mdx) — how context spans inline, transit, and filesystem
4. [Context Pressure](./concepts/context-pressure.mdx) — how truncation is tracked and surfaced
5. [Model Routing](./concepts/model-routing.mdx) — how planner and synthesizer roles are assigned
