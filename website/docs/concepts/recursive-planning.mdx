...
|----------|-----------------|
| **Execution pressure** | Adds a planner review note that biases edit-oriented turns toward likely file action instead of repeated broad retrieval |
| **Evidence pressure** | Adds a planner review note when sources start to outweigh the original premise, so the planner must refine, stop, or continue explicitly |
