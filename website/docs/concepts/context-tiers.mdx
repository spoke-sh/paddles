...
| **Sift** | Indexed evidence in retrieval indexes | Query-based retrieval (future) |
...
- `ContextLocator::Sift { index_ref }` — an indexed retrieval reference (future)
...
- [Context Pressure](./context-pressure.mdx) — how truncation events are tracked and surfaced
