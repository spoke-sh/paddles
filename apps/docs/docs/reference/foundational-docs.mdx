...
5. [Recursive Planning](../concepts/recursive-planning.mdx) for how steering signals change action-selection behavior
...
- [Search and Retrieval](../concepts/search-retrieval.mdx) — retrieval modes, caps, and trace
