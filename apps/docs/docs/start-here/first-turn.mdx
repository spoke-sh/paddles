...
- [Recursive Planning](../concepts/recursive-planning.mdx) — how action selection drives investigation
- [Search and Retrieval](../concepts/search-retrieval.mdx) — how retrieval queries are bounded and traced
